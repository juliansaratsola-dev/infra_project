...
# Security Group for RKE2 nodes
resource "aws_security_group" "rke2_nodes" {
  name        = "${var.project_name}-${var.environment}-rke2-nodes-sg"
  ...
  # RKE2 supervisor and Kubernetes API
  ingress {
    from_port   = 9345
    to_port     = 9345
    protocol    = "tcp"
